...
//becaues there where we manage our user Id of the logged in user and for that we all need to import Auth context
import { AuthContext } from '../../shared/context/auth-context';
//upadte places
const UpdatePlace = () => {
	const auth = useContext(AuthContext);
	const { isLoading, error, sendRequest, clearError } = useHttpClient();
	//here we want to send a request whene this page loads to load the latest place data so need useEffect and useState
	...
	//use this useEffect to send a request and fetch our data
	useEffect(
		() => {
